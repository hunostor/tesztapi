...
{
    public class Female : Gender, IHumanCalorieCalculator
    {
        public override Genders SexName { get; } = Genders.Female;

        protected override int _baseCalorie { get; } = 1400;

        protected override int _baseAge => 18;

        protected override int _baseHeight => 140;

        protected override int _baseWeight => 45;

        protected override int _modifierForAge => 3;

        protected override int _modifierForHeight => 5;
